...
# Parsing Script – isensorDEMO - Rev. A

This **Parsing** script is designed for the **isensorDEMO** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – isensorDEMO Rev. A

Este script de **Parsing** está diseñado para el modelo **isensorDEMO** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
